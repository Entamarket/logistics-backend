...
router.post(
  ...
  (req, res) => shipmentController.uploadDeliveryProof(req as AuthRequest, res)
);

router.patch("/:id/confirm-receipt", authMiddleware, (req, res) =>
  shipmentController.confirmSenderReceipt(req as AuthRequest, res)
);
